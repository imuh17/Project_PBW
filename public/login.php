...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <h1 class="text-3xl font-bold mb-6 text-center text-blue-600">Login to Filmyfy</h1>
        <form action="login_process.php" method="post">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white p-3 w-full rounded-md mt-4 font-semibold transition duration-300">Login</button>
        </form>
        <p class="mt-4 text-center text-sm text-gray-600">Don't have an account? <a href="register.php" class="text-blue-500 hover:text-blue-700">Sign up</a></p>
    </div>
</body>
</html>
